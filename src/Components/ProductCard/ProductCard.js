...
const ProductCard = ({ product }) => {
  ...
  return (
    <>
      <div className=" border p-5 bg-gradient-to-b from-blue-100 to-blue-100  text-sm overflow-hidden hover:border  hover:shadow-xl">
        ...
        <div className="mt-3 text-gray-400">
          <h3 className="font-semibold text-xl text-gray-600 hover:text-[#c801ff]">
          ...
          <div className="flex justify-between items-center mt-4">
            <p
              ...
              className="flex gap-1 border p-2     hover:bg-[#c801ff] hover:text-white items-center"
            >
            ...
            <button
              ...
              className="bg-[#c801ff] hover:bg-gray-700 text-white p-2 "
            >
              Book Now
            </button>
          </div>
          ...
          {user?.uid ? (
            <form onSubmit={submitHandler} className="text-sm">
              ...
              <div className="flex items-center justify-end mt-2  ">
                <button
                  className="text-[#c801ff] background-transparent font-bold uppercase px-6 py-2 text-sm outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                  type="button"
                ...
                <button
                  className="bg-[#c801ff] text-white active:bg-emerald-600 font-bold uppercase text-sm px-6 py-3   hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                  type="submit"
                >
                  Confirm
                </button>
